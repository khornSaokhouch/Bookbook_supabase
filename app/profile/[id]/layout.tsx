// app/components/UserLayout.tsx (or wherever your UserLayout is)
"use client";
...
const UserLayout = ({ children }: UserLayoutProps) => {
  ...
  // Create a div element for the portal target only once
  useEffect(() => {
  ...
  return (
    // Wrap the entire layout content with AlertProvider
    <AlertProvider>
