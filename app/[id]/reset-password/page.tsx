    ...
    >
      ...
      >
        <div className="flex items-center justify-center mb-4">
          ...
          <h1 className="text-2xl font-bold text-center text-gray-900 dark:text-white">Change Password</h1>
        </div>
        <p className="text-gray-600 dark:text-gray-300 text-center mt-2">Enter your details to update your password.</p>
        ...
        <form onSubmit={handleOpenConfirm} className="mt-6 space-y-4">
          ...
          <motion.div variants={itemVariants}>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-200">Old Password</label>
            <input
              type="password"
              className="w-full border border-gray-300 dark:border-gray-700 rounded-md p-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
              value={oldPassword}
      ...
      {isConfirmOpen && (
        ...
        >
          <motion.div
            ...
            variants={itemVariants}
          >
            <p className="text-gray-700 dark:text-gray-300 text-center mb-4">Are you sure you want to change your password?</p>
