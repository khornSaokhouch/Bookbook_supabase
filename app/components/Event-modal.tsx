      ...
      >
        ...
        >
          ...
          <div className="flex justify-between items-center mb-8 border-b border-gray-200 dark:border-gray-700 pb-6">
            ...
            <button
              onClick={onClose}
              className="text-gray-500 dark:text-gray-400 hover:text-red-500 transition duration-200 hover:scale-110 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800"
            >
                ...
                <div className="relative z-10 flex flex-col items-center">
                  ...
                  <div className="text-center">
                    <p className="text-gray-700 dark:text-gray-300 text-xl font-semibold mb-2">
                      {imageFile?.name || "Upload Event Image"}
                    </p>
              ...
              >
                ...
                {loading ? (
                  <>
                    ...
                    <span className="text-lg">Saving Event...</span>
                  </>
                ) : (
                  <>
